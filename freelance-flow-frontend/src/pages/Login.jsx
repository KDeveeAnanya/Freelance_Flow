    ...
    <div style={s.page}>
      <div style={s.left}>
        <div style={s.leftInner}>
          ...
          <div style={s.bigLine}>Welcome</div>
          <div style={s.bigLine}><span style={s.gold}>back.</span></div>
          <p style={s.leftSub}>Track your work, manage your clients, and get paid on time.</p>
